...
import { DocumentNumbersCount } from "../resolvers/outputs/DocumentNumbersCount";

@TypeGraphQL.ObjectType("DocumentNumbers", {})
export class DocumentNumbers {
  ...
  sequenceValues?: SequenceNumbers[];

  @TypeGraphQL.Field(_type => DocumentNumbersCount, {
    nullable: true
  })
  _count?: DocumentNumbersCount | null;
}
