...
import { SiteOrderByRelationAggregateInput } from "../inputs/SiteOrderByRelationAggregateInput";
...
export class CompanyOrderByWithRelationInput {
  ...
  @TypeGraphQL.Field(_type => SiteOrderByRelationAggregateInput, {
    nullable: true
  })
  sites?: SiteOrderByRelationAggregateInput | undefined;
}
