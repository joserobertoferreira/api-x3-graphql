...
import { SalesOrderLineCreateNestedOneWithoutPriceInput } from "../inputs/SalesOrderLineCreateNestedOneWithoutPriceInput";

@TypeGraphQL.InputType("SalesOrderPriceCreateWithoutProductDetailsInput", {})
export class SalesOrderPriceCreateWithoutProductDetailsInput {
  ...
  @TypeGraphQL.Field(_type => SalesOrderLineCreateNestedOneWithoutPriceInput, {
    nullable: true
  })
  line?: SalesOrderLineCreateNestedOneWithoutPriceInput | undefined;
}
