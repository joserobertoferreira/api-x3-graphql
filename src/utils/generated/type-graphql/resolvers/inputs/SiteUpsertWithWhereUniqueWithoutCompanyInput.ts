...
@TypeGraphQL.InputType("SiteUpsertWithWhereUniqueWithoutCompanyInput", {})
export class SiteUpsertWithWhereUniqueWithoutCompanyInput {
  ...
  update!: SiteUpdateWithoutCompanyInput;
