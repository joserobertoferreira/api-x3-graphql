...
@TypeGraphQL.InputType("SalesOrderPriceOrderByWithRelationInput", {})
export class SalesOrderPriceOrderByWithRelationInput {
  ...
  line?: SalesOrderLineOrderByWithRelationInput | undefined;
