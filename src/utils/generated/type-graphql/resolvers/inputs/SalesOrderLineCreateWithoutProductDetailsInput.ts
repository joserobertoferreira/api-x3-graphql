...
import { SalesOrderPriceCreateNestedOneWithoutLineInput } from "../inputs/SalesOrderPriceCreateNestedOneWithoutLineInput";

@TypeGraphQL.InputType("SalesOrderLineCreateWithoutProductDetailsInput", {})
export class SalesOrderLineCreateWithoutProductDetailsInput {
  ...
  @TypeGraphQL.Field(_type => SalesOrderPriceCreateNestedOneWithoutLineInput, {
    nullable: true
  })
  price?: SalesOrderPriceCreateNestedOneWithoutLineInput | undefined;
}
